...
-- `ledger` table
INSERT INTO `ledger`(`invoice`, `phone`, `id_barang`, `start_date`, `end_date`, `price`, `returned`, `paid`) VALUES ('[value-1]','[value-2]','[value-3]','[value-4]','[value-5]','[value-6]','[value-7]','[value-8]');
